...
const Home = () => {
    ...
    return(
        <>
            ...
            <motion.div variants={variants} initial='hidden' animate='show' className='home'>
                ...
                <motion.div variants={item}>
                    ...
                    <button className='github-link'>
                        <a rel='noopener' href='https://github.com/leszekkorzan'>
                            <img alt='Logo' className='icon-btn' src='img/github-black.svg'/>GitHub
                        </a>
                    </button>
                </motion.div>
                <div className='copyright'>2016-2020 &copy; Leszekk.eu</div>
            </motion.div>
        </>
    )
}
